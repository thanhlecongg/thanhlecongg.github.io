...
<section id="two" class="spotlights">
	<section id="two-one">
		<a href="" class="image">
			<img src="{% link assets/images/landing-iot-project.jpg %}" alt="" data-position="top center" />
		</a>
		<div class="content">
			<div class="inner">
				<header class="major">
				...
				<a href="./apr.html" class="button icon fa-newspaper-o">Learn More</a>
			</div>
		</div>
	</section>
...
<section id="two-two">
		...
		<div class="content">
			<div class="inner">
				...
				<a href="./vm.html" class="button icon fa-newspaper-o">Learn More</a>
			</div>
		</div>
	</section>
</section>
