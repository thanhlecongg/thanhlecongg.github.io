	...
	<section>
		...
		<div class="content">
			<div class="inner">
                ...
                To address this problem, my colleagues and I have proposed <a href="./pdf/TSE_Invalidator.pdf"> Invalidator (TSE'23-Minor Revision) </a> an automated method to reason the correctness of APR-generated patches via program invariants and code representations. We further developed <a href="coming_soon.html"> PatchZero (Under Submission)
		...
		<div class="content">
			<div class="inner">
                ...
                Towards this goal, my colleagues and I have designed a comprehensive array of novel automated solutions that leveraged data-driven approaches to support developers and security practitioners in various tasks including: 
                 <ul>
                    <li>Identifying vulnerability-fixing commits <a href="./pdf/VulCurator.pdf"> [VulCurator (ESEC/FSE'22)</a>, <a href="coming_soon.html"> Midas (Under Submission)]</a></li>
